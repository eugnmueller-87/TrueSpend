...
// ── 8. Tickets ────────────────────────────────────────────────
const tickets = [
  {ref:'TS-2026-0201', src:'intake',     status:'auto_executed',      cat:'saas_license', title:'Figma Organization × 6 seats — DACH Design',                          branch:'b1000000-0000-0000-0000-000000000002', sup:null,                                       owner:'e1000000-0000-0000-0000-000000000003', by:'Lena Hoffmann',  email:'lena.hoffmann@company.com',  val:270,    disp:'auto_execute', conf:0.97, rec:'Auto-approved. Figma Org €45/seat. Budget 38% headroom. No conflict.', mins:300},
  {ref:'TS-2026-0202', src:'automatic',  status:'auto_executed',      cat:'hardware',     title:'Dell Dock WD19S × 8 — Nordics reorder',                               branch:'b1000000-0000-0000-0000-000000000006', sup:'f1000000-0000-0000-0000-000000000001', owner:'e1000000-0000-0000-0000-000000000004', by:'Erik Lindqvist', email:'erik.lindqvist@company.com', val:1592,   disp:'auto_execute', conf:0.99, rec:'Auto-approved. Dell contract active. Price confirmed.', mins:180},
  {ref:'TS-2026-0203', src:'intake',     status:'pending_review',     cat:'saas_license', title:'Notion Team × 12 seats — UK Product',                                 branch:'b1000000-0000-0000-0000-000000000003', sup:null,                                       owner:'e1000000-0000-0000-0000-000000000004', by:'Erik Lindqvist', email:'erik.lindqvist@company.com', val:1584,   disp:'one_touch',    conf:0.71, rec:'One-touch. No Notion contract. Capability overlap with Confluence.', mins:120},
  {ref:'TS-2026-0204', src:'intake',     status:'pending_review',     cat:'saas_license', title:'Salesforce Sales Cloud — 5 additional seats France',                   branch:'b1000000-0000-0000-0000-000000000005', sup:'f1000000-0000-0000-0000-000000000008', owner:'e1000000-0000-0000-0000-000000000002', by:'Marc Dupont',    email:'marc.dupont@company.com',    val:9900,   disp:'one_touch',    conf:0.68, rec:'One-touch. France SaaS 102% committed. Entitlement already 6 over quota.', mins:90},
  {ref:'TS-2026-0205', src:'intake',     status:'escalated',          cat:'services',     title:'McKinsey — Digital Operations Assessment €220k',                       branch:'b1000000-0000-0000-0000-000000000001', sup:null,                                       owner:'e1000000-0000-0000-0000-000000000001', by:'Sarah Brennan',  email:'sarah.brennan@company.com',  val:220000, disp:'escalate',     conf:0.91, rec:'Escalated. >€100k, new supplier, SOW overlap with Accenture.', mins:45, jira:'PROC-2205'},
  {ref:'TS-2026-0206', src:'intake',     status:'signature_required', cat:'services',     title:'NDA — Databricks EMEA Ltd — AI Data Platform evaluation',              branch:'b1000000-0000-0000-0000-000000000001', sup:null,                                       owner:'e1000000-0000-0000-0000-000000000001', by:'Sarah Brennan',  email:'sarah.brennan@company.com',  val:0,      disp:'one_touch',    conf:0.88, rec:'NDA prepared. GDPR DPA required. InfoSec 82/100. Signature needed.', mins:30},
  {ref:'TS-2026-0207', src:'intake',     status:'pending_confirm',    cat:'hardware',     title:'Apple iPhone 15 Pro × 4 — Italy sales team',                          branch:'b1000000-0000-0000-0000-000000000008', sup:'f1000000-0000-0000-0000-000000000003', owner:'e1000000-0000-0000-0000-000000000005', by:'Priya Nair',     email:'priya.nair@company.com',     val:4796,   disp:'one_touch',    conf:0.94, rec:'Catalogue item. Apple contract active. Budget available. One-touch.', mins:15},
  {ref:'TS-2026-0208', src:'renewal',    status:'auto_executed',      cat:'hardware',     title:'Auto-renewed: Dell Hardware Framework — Global HQ',                    branch:'b1000000-0000-0000-0000-000000000001', sup:'f1000000-0000-0000-0000-000000000001', owner:'e1000000-0000-0000-0000-000000000001', by:'Sarah Brennan',  email:'sarah.brennan@company.com',  val:480000, disp:'auto_execute', conf:0.96, rec:'Auto-renewed. Clean terms. Extended 12mo to 2027-07-10.', mins:2880},
  {ref:'TS-2026-0209', src:'renewal',    status:'pending_review',     cat:'saas_license', title:'Renewal: Salesforce Sales Cloud France — 8% price increase',           branch:'b1000000-0000-0000-0000-000000000005', sup:'f1000000-0000-0000-0000-000000000008', owner:'e1000000-0000-0000-0000-000000000002', by:'Marc Dupont',    email:'marc.dupont@company.com',    val:181764, disp:'one_touch',    conf:0.83, rec:'Counter at 3% + right-size to 79 seats. Market benchmark 4-5%.', mins:1440},
  {ref:'TS-2026-0210', src:'monitoring', status:'pending_review',     cat:'hyperscaler',  title:'AWS spend anomaly — Global HQ 3.4× spike vs 7-day avg',               branch:'b1000000-0000-0000-0000-000000000001', sup:'f1000000-0000-0000-0000-000000000004', owner:'e1000000-0000-0000-0000-000000000001', by:'Sarah Brennan',  email:'sarah.brennan@company.com',  val:48200,  disp:'one_touch',    conf:0.87, rec:'Anomaly 3.4× baseline. RI util 61% vs normal 89%. Review instances.', mins:360},
]
for (const t of tickets) {
  await q(`INSERT INTO tickets (reference,source,status,title,category,branch_id,supplier_id,owner_id,submitted_by,submitted_by_email,value_eur,amount_eur,disposition,recommendation,confidence,jira_key,jira_url,created_at)
    VALUES($1,$2::ticket_source,$3::ticket_status,$4,$5,$6,$7,$8,$9,$10,$11,$11,$12::disposition,$13,$14,$15,$16,now()-($17||' minutes')::interval)
    ON CONFLICT (reference) DO UPDATE SET category=$5,status=$3::ticket_status`,
    [t.ref,t.src,t.status,t.title,t.cat,t.branch,t.sup||null,t.owner,t.by,t.email,t.val,t.disp,t.rec,t.conf,
