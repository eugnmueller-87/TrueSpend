...
// ─── Config ───────────────────────────────────────────────────────────────────
// Priority: window.__CONFIG__ (runtime, from /config.js generated by docker-entrypoint.sh)
//        → import.meta.env.VITE_* (build-time, for local dev)
//        → hardcoded fallback (last resort)
const __CFG = (typeof window !== 'undefined' && window.__CONFIG__) || {}
const POSTGREST_URL    = __CFG.POSTGREST_URL    || import.meta.env.VITE_POSTGREST_URL    || 'https://postgrest-production-7960.up.railway.app'
const POSTGREST_JWT    = __CFG.POSTGREST_JWT    || import.meta.env.VITE_POSTGREST_JWT    || ''
const N8N_WEBHOOK      = __CFG.N8N_WEBHOOK_URL  || import.meta.env.VITE_N8N_WEBHOOK_URL  || 'https://n8n-n3xl.eugenmueller.tech/webhook/intake'
const N8N_WEBHOOK_BASE = __CFG.N8N_WEBHOOK_BASE || import.meta.env.VITE_N8N_WEBHOOK_BASE || 'https://n8n-n3xl.eugenmueller.tech/webhook'
